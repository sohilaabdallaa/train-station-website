...
<?php
        ...
        $_SESSION['msg']='Your trip has been cancelled succesfully!';
        $sql="SELECT * FROM book,trip Where Email Like '$email' AND Book.TripID=Trip.TripID ";
        ...
        echo ("
            ...
            <form onsubmit=\"return confirm('Do you really want to cancel the trip?');\" action = 'confEmail.php' method ='POST' >
            ...
            <button id='Cancel-btn'  name='Cancel-btn' type='submit' style=' text-decoration: none;border: none; padding: 12px;
                    background-color: powderblue;color: black;font-size:20px;
                    border-radius: 40px;cursor: pointer;margin-left:90px; margin-top:20px; width:150px;'>Cancel</button >

            <input type='hidden' value=".$row['BookID']." name='input2'/>
