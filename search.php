 ...
 if (isset($_POST['search-btn']))
    {
        ...
        $sql="SELECT * FROM Trip,Train WHERE source LIKE '%$Source%' AND Destination LIKE '%$Destination%' AND Trip.TrainID =Train.TrainID ;";
        ...
        while($row=mysqli_fetch_assoc($result))
        {
            ...
            echo ("
                ...
                <button id='Book-btn'  name='Book-btn' type='submit' style=' text-decoration: none;border: none; padding: 12px;
                        ...
                        border-radius: 40px;cursor: pointer;margin-left:90px; margin-top:20px; width:150px;'>Book</button >

                <input type='hidden' value= $row[TripID] name='input2'/>
